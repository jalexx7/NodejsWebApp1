...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        return (React.createElement(Grid, { fluid: true },
            ...
            React.createElement(Row, { className: "hello" },
...
var Header = /** @class */ (function (_super) {
    ...
    Header.prototype.render = function () {
        return (React.createElement("div", { className: "hello" },
            React.createElement("h1", { className: "hello" }, "Header - Make this much longer so that it goes across the screen and maybe we can use react bootstrap to modify. bloop blop")));
    };
    return Header;
}(React.Component));
